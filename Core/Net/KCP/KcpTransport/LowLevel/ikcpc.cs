...
namespace KcpTransport.LowLevel
{
	...
	*l = *(byte*)(p + 0) + (*l << 8);
        ...
        {
            return (IKCPSEG*)ikcp_malloc((IntPtr)sizeof(IKCPSEG) + size);
        }
        ...
        {
            ikcpcb* kcp = (ikcpcb*)ikcp_malloc((IntPtr)sizeof(ikcpcb));
...
#if true
            //	printf("snd(bufferCache=%d, queue=%d)\n", kcp->nsnd_buf, kcp->nsnd_que);
            //	printf("rcv(bufferCache=%d, queue=%d)\n", kcp->nrcv_buf, kcp->nrcv_que);
#endif
        }
